...
<sql:query dataSource="${ic}" var="oc">
    ...
    SELECT * FROM room WHERE spaceid=?
                  ...
                  <div class="details room">
                    ...
                    <div class="fields">
                      <div class="input-field input-box">
                        ...
                        <input type="text" name="spacename" value="${room.spacename}">
                      </div>
                      <div class="input-field input-box">
                        <label class="details">Kapasiti</label>
                        <input type="text" name="spacecapacity" value="${room.spacecapacity}">
                      </div>
                      <div class="input-field input-box">
                        <label class="details">Status</label>
                        <c:set var = "status" scope = "session" value = "${room.spacestatus}"/>
                        <c:if test = "${status == 'Boleh Digunakan'}">
                            <select name="spacestatus">
                                <option value="${room.spacestatus}">${room.spacestatus}</option>
                      ...
                      <div class="input-field input-box">
                        ...
                        <input type="text" name="soundsystem" value="${room.soundsystem}">
                      </div>
                      <div class="input-field input-box">
